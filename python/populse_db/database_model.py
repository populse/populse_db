...
LIST_TYPES = [TAG_TYPE_LIST_STRING, TAG_TYPE_LIST_INTEGER, TAG_TYPE_LIST_FLOAT, TAG_TYPE_LIST_BOOLEAN, TAG_TYPE_LIST_DATE, TAG_TYPE_LIST_DATETIME, TAG_TYPE_LIST_TIME]
SIMPLE_TYPES = [TAG_TYPE_STRING, TAG_TYPE_INTEGER, TAG_TYPE_FLOAT, TAG_TYPE_BOOLEAN, TAG_TYPE_DATE, TAG_TYPE_DATETIME, TAG_TYPE_TIME]
ALL_TYPES = [TAG_TYPE_LIST_STRING, TAG_TYPE_LIST_INTEGER, TAG_TYPE_LIST_FLOAT, TAG_TYPE_LIST_BOOLEAN, TAG_TYPE_LIST_DATE, TAG_TYPE_LIST_DATETIME, TAG_TYPE_LIST_TIME, TAG_TYPE_STRING, TAG_TYPE_INTEGER, TAG_TYPE_FLOAT, TAG_TYPE_BOOLEAN, TAG_TYPE_DATE, TAG_TYPE_DATETIME, TAG_TYPE_TIME]
