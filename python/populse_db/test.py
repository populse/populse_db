    ...
    class TestDatabaseMethods(unittest.TestCase):
        ...
        def test_remove_value(self):
            ...
            database.add_field("collection1", "PatientName", populse_db.database.FIELD_TYPE_STRING,
                                        "Name of the patient")
            database.add_field("collection1", "Bits per voxel", populse_db.database.FIELD_TYPE_INTEGER, None)
            database.add_field("collection1", "Dataset dimensions",
            ...
            try:
                ...
                pass
            database.new_value("collection1", "document1", "Dataset dimensions", [3, 28, 28, 3])
            ...
            self.assertIsNone(database.get_value("collection1", "document1", "PatientName"))
            self.assertIsNone(database.get_value("collection1", "document1", "Bits per voxel"))
            self.assertIsNone(database.get_value("collection1", "document1", "Dataset dimensions"))
